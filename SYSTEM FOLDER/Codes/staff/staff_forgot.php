...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result && $result->num_rows > 0) {
        ...
        $update_sql = "UPDATE staff SET reset_token=?, reset_expires=? WHERE email=?";
        ...
        if ($update_stmt->affected_rows > 0) {
            ...
            try {
                ...
                $reset_link = "http://localhost/MASTER PROJECT - Satay kajang Uncle Ujang G05/Satay-Kajang-Uncle-Ujang-Online-Ordering-System-G5/SatayKajangUncleUjangOnlineOrderingSystem/staff/staff_reset.php?token=" . $token;

                $mail->isHTML(true);
                $mail->Subject = 'Staff Password Reset Request';
                $mail->Body    = "
...
<head>
    ...
    <link rel="stylesheet" href="../CSS/staff_forgot.css">
</head>
<body>
            ...
            <div class="container">
                ...
                <form method="POST">
                    <div class="form-group">
                        ...
                        <input type="email" name="email" id="email" placeholder="Enter your staff email" required>
                    </div>
                    <button type="submit" class="btn">Reset Password</button>

                <!-- Back to Login as Button -->
                <a href="staff_login.php"  class="back-btn">← Back to Login</a>
                </form>
            </div>
        </section>
    </main>
