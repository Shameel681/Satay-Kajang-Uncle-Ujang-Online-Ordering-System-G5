...
$staff_id = $is_loggedin ? $_SESSION['staff_id'] : null;
...
try {
    ...
    // Total Customers (Line 30 and other single fetches are now handled safely)
                                        ...
                                        <div class="card-tools">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="staff_manageorder.php">View All</a>
                                                    </div>
                                            </div>
                                        </div>
                                    </div>
