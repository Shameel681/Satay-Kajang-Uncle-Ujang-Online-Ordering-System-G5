...
// Fetch staff data
$stmt = $conn->prepare("SELECT name, email, phone_no, address, staff_image, created_at FROM staff WHERE staff_id = ?");
if (!$stmt) {
...
<head>
    ...
    <title>Staff Profile - Satay Kajang Uncle Ujang</title>
                            ...
                            <li class="nav-item topbar-user dropdown hidden-caret">
                                ...
                                <ul class="dropdown-menu dropdown-user animated fadeIn">
                                    <li>
                                        ...
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="../staff/change_staff.php">
                ...
                <div class="page-inner">
                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            ...
                            <p class="op-7 mb-2">Manage your staff account information and preferences</p>
                        </div>
                    </div>
                            ...
                            <div class="card profile-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-2 text-center mb-3">
                                            <div class="position-relative">
                                                <?php if (!empty($staff['staff_image'])): ?>
                                                    <img src="../Uploads/staff/<?php echo htmlspecialchars($staff['staff_image']); ?>" 
                                                ...
                                                <?php endif; ?>
                                                <form action="upload_img_staff.php" method="POST" enctype="multipart/form-data" id="imageForm" style="display: inline;">
                                                    <input type="file" name="staff_image" id="profileImage" accept="image/*" class="d-none" style="display: none;">
                                        ...
                                        <div class="col-md-10">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <h3 class="fw-bold mb-1"><?php echo htmlspecialchars($staff['name']); ?></h3>
                                                    <p class="text-muted mb-0">Staff</p>
                                                    <p class="text-primary fw-semibold">STAFF<?php echo sprintf('%04d', $staff_id); ?></p>
                                                </div>
                                                <div class="col-md-6 text-md-end">
                                                    ...
                                                    <span class="badge badge-info">
                                                        ...
                                                        <?php echo date('M Y', strtotime($staff['created_at'])); ?>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!-- Profile Info Form -->
                                    <form action="profStaffUpdate.php" method="POST" id="profileForm">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" 
                                                           ...
                                                           value="STAFF<?php echo sprintf('%04d', $staff_id); ?>" 
                                                           readonly>
                                                    <div class="form-text text-muted">Your unique staff identifier</div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" 
                                                           name="phone_no" 
                                                           class="form-control readonly-field" 
                                                           value="<?php echo htmlspecialchars($staff['phone_no'] ?? ''); ?>" 
                                                           pattern="[0-9]{10,11}" 
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="address" 
                                                              ...
                                                              disabled><?php echo htmlspecialchars($staff['address'] ?? ''); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-footer profile-actions bg-light p-3">
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <a href="../staff/change_staff.php" class="btn btn-warning">
                                            <i class="fa-solid fa-lock me-2"></i>Change Password
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col col-stats ms-3 ms-sm-0">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title text-warning">Staff</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col col-stats ms-3 ms-sm-0">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title"><?php echo date('M Y', strtotime($staff['created_at'])); ?></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
