...
if (!$is_loggedin) {
    header("Location: profStaff.php"); // redirect to staff profile/login
    exit;
}
?>
...
<head>
  ...
  <link rel="stylesheet" href="../CSS/admin_dashboard.css"><!-- reuse same CSS -->
...
<div class="dashboard-wrapper">
    ...
    <main class="dashboard-content">
        <header class="dashboard-header">
            <h1>Welcome, Staff!</h1> <strong><?php echo $staff_name; ?></strong>
            <p>Manage your tasks efficiently with the tools below.</p>
        </header>
