        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Staff Login</h1>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8">
                <div class="bg-light rounded p-5 shadow">
                    <h2 class="text-center mb-4 text-primary">Staff Login</h2>
                    <p class="text-center text-muted mb-4">Only authorized staff can log in here.</p>
                    ...
                    <form action="" method="POST">
                        <div class="mb-3">
                            <label class="form-label"><i class="fa fa-envelope"></i> Staff Email</label>
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <a href="staff_forgot.php" class="text-decoration-none" style="color: #f07b3f; font-weight: bold;">Forgot password?</a>
                        </div>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link" href="staff_login.php">Staff Login</a>
